...
const DataCenters = () => {
  return (
    <div className="pt-12 pb-6  text-center bg-white">
      <h3
        data-aos="fade-up"
        className="sm:text-lg text-gray-900 md:text-3xl lg:text-3xl"
      >
        The solutions we offer
      </h3>
      <p
        data-aos="fade-up"
        className="pt-4 text-gray-400 lg:text-xl sm:text-sm "
      >
        ...
        <div className="hero min-h-screen bg-white">
          <div className="flex-col hero-content lg:flex-row-reverse">
            ...
            <div>
              <h1
                data-aos="fade-up"
                className=" mb-6 text-left text-3xl font-bold"
              >
              ...
              <p data-aos="fade-up" className="mb-5 text-left">
                ...
                <div className="pt-4">
                  <Link
                    ...
                    className="btn text-white  bg-[#010230]"
                  >
                    Learn More
                  </Link>
                </div>
              ...
              <div className="flex-col hero-content lg:flex-row-reverse">
                <div>
                  ...
                  <p data-aos="fade-up" className="mb-5 text-left">
                    ...
                    <br />
                    <div data-aos="zoom-in-up" className="pt-4">
      ...
      <div className="pt-2">
        <button data-aos="zoom-in-up" className="btn text-white bg-[#46108C]">
          Our More Services
        </button>
